...
7. You can predict the label of images in the test_image folder by pasting their path into in filename, custom images can be added to that folder prior to building the docker image 
